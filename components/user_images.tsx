...
export default function UserImages({ images, alt }) {
  ...
  return (
    <div className="relative">
      <Image src={'/' + banner} alt={alt} width={1920} height={640} objectFit="cover" className="rounded-xl" />
      <div
        ref={ref}
        className="absolute left-1/2 -bottom-16 z-10 -translate-x-1/2 transform cursor-pointer rounded-full"
      >
        <Image src={'/' + avatar} alt={alt} width={120} height={120} objectFit="cover" className="rounded-full" />
